...
import { useExecuteModelsQuery } from "@/hooks/query/useModelsQuery";
...
function ExecutableModelTable() {
  ...
  const { data: dataModels, refetch } = useExecuteModelsQuery(params, true);
...
export default ExecutableModelTable;
